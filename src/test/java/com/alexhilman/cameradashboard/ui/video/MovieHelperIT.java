...
public class MovieHelperIT {
    private final MovieHelper movieHelper = new MovieHelper();
    ...
    public void shouldGrabFrame() throws Exception {
        final byte[] bytes = movieHelper.grabJpgFrame(new File("/tmp/2017-09-24 12:51:01.mp4"), 3000);
